...
public class SemanticBankSearchStorageTest
{
    ...
    {
        AccountStorageDocument document = new Gson().fromJson("{\"schemaVersion\":1,\"catalogueVersion\":\"legacy-rules-v1\",\"items\":[{\"itemId\":2434,\"quantity\":2,\"sourceType\":\"BANK\",\"sourceName\":\"Bank\",\"currentlyVisible\":true,\"lastSeenMillis\":1000}]}", AccountStorageDocument.class);
    ...
    {
        AccountStorageDocument document = new Gson().fromJson("{\"schemaVersion\":1,\"catalogueVersion\":\"legacy-rules-v1\",\"items\":[{\"itemId\":2434,\"quantity\":-2,\"sourceType\":null,\"sourceName\":null,\"lastSeenMillis\":-1000},{\"itemId\":0}]}", AccountStorageDocument.class);
    ...
    {
        AccountStorageDocument document = new Gson().fromJson("{\"schemaVersion\":1,\"catalogueVersion\":\"legacy-rules-v1\",\"items\":[{\"itemId\":4151}]}", AccountStorageDocument.class);
